...
/// gap since the last activity exceeds `timeout` (default 30 minutes) — brief
...
@_spi(Testing) public final class SessionTracker {
    ...
    public init(timeout: TimeInterval = 30 * 60, defaults: UserDefaults = .standard, uuid: @escaping () -> String = { UUID().uuidString }) {
